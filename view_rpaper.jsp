   ...
   <!-- home start -->
   	<div class="templatemo_topbg topmargin">
        ...
        <div class="col-md-4"><img src="images/templatemo_homeicon.png" alt="template grand"></div>
                <div class="col-md-8 margin40">
					...
					<div class="title">View The Paper And Assign to Reviewers</div>
	...
	<table width="606" height="219" align="center"  >
		   ...
		   <td width="228"><font  color="#CC0000"size="3"><strong>File Size </strong></font></td>
			 ...
			 <td width="228"><font  color="#CC0000"size="3"><strong>View Comments </strong></font></td>
...
con=databasecon.getconnection();
 ...
 String sqll="select * from assign where remail='"+e+"' AND status='"+new1+"'";
...
<a href="download.jsp?pp=<%=pid%>">Download ANd Verify</a>
...
<a href="comments.jsp?pp=<%=pid%>">Write The Command</a>
