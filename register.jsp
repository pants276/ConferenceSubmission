  ...
  <div class="container"> 
   ...
   <!-- contact start -->
     ...
     <div class="container">
      ...
      <div class="col-md-4"> 
        <div class="templatemo_contact_map shadow"> <img src="images/register.jpg" width="340" height="418"> 
        </div>
      </div>
      ...
      <div class="col-md-8"> 
        <div class="templatemo_contact_form shadow"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
          ...
          <form action="register1.jsp" method="get">
            <input type="text" id="nametext" name="name" placeholder="Your Name...">
            ...
            <select name="tech">
              ...
              <option value="nv" >NoVoice</option>
