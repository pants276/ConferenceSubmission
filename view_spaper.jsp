  ...
  <div class="container"> 
   ...
   <!-- home start -->
   	<div class="templatemo_topbg topmargin">
        ...
        <div class="col-md-4"><img src="images/templatemo_homeicon.png" alt="template grand"></div>
                <div class="col-md-8 margin40">
					...
					<div >
					<font size="3" ><b>View  Submited papers from Authors for Conference</b></font></div>
	...
	<table width="606" height="219" align="center"  >
			...
			<tr     bgcolor="#000000">
			<td width="172"  ><font  color="#CC0000"size="3"><strong> Author Id</strong></font></td>
			
            <td width="228"><font  color="#CC0000"size="3"><strong>Author Name</strong></font></td>
			
		
		   <td width="228"><font  color="#CC0000"size="3"><strong>Submited Date And Time </strong></font></td>
		   <td width="228"><font  color="#CC0000"size="3"><strong>File Size </strong></font></td>
		     <td width="228"><font  color="#CC0000"size="3"><strong>Assign Action </strong></font></td>
...
con=databasecon.getconnection();
 ...
 String sqll="select * from paper where status='"+new1+"'";
...
<a href="up_permission.jsp?a=<%=uemail%>">Assign</a>
