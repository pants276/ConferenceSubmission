...
PreparedStatement ps1=con1.prepareStatement("update paper set status=? where pid='"+aa+"'");
ps1.setString(1,b);
ps1.executeUpdate();
...
PreparedStatement ps2=con2.prepareStatement("update paper set status=? where pid='"+aa1+"' ");
ps2.setString(1,b1);
ps2.executeUpdate();
