     ...
     <div class="container">
      ...
      <div class="col-md-8"> 
        <div class="templatemo_contact_form shadow"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
          ...
          <form action="up1.jsp" method="post" enctype="multipart/form-data">
            <table>
              <tr> 
                <td> Conference Name </td>
                <td><input type="text" name="cname" value="<%=a%>"></td>
              </tr>
              <tr> 
                <td>choose your paper</td>
                <td><input type="file" name="file">
                  <strong><font color="#CC0066" size="3">(Choose only Pdf Files)</font></strong></td>
              </tr>
              <tr> 
