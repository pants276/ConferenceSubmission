  ...
  <div class="container"> 
            ...
            <div id="top-menu"> 
              <div class="collapse navbar-collapse main_menu" id="bs-example-navbar-collapse-1"> 
                <ul class="nav navbar-nav">
                  ...
                  <li><a href="view_rpaper.jsp">Back</a></li>
                </ul>
              </div>
            </div>
            <!-- /.navbar-collapse -->
   ...
   <!-- contact start -->
     ...
     <div class="container">
      ...
      <div class="col-md-4"> 
        <div class="templatemo_contact_map shadow"> <img  src="images/comments.jpg" width="328" height="413"> 
        </div>
      </div>
      ...
      <div class="col-md-8"> 
        <div class="templatemo_contact_form shadow"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
          ...
          <br>
          <%
		  String a=request.getParameter("pp");
		  %>
          <form action="comments_insert.jsp" method="post">
            <table  width="500">
              <tr> 
                <td>pid</td>
                <td><input type="text" name="pid" value="<%=a%>"></td>
              </tr>
              <tr> 
                <td>Comments</td>
                <td> <textarea name="comment"  rows="15" cols="15"></textarea> 
                </td>
              </tr>
              <tr> 
                <td>Provide Rating</td>
                <td> <select name="rate">
                    <option value="0">---Select---</option>
                    <option value="1">Above 20%</option>
                    <option value="2">Above 40%</option>
                    <option value="3">Above 60%</option>
                    <option value="4">Above 80%</option>
