     	...
     	<div class="row templatemo_aboutmid">
        	<div class="col-md-3 margin30">
            	...
            	<div class="templatemo_gradient2">
                	<div class="name">View Events</div>
                    <a href="v_events.jsp">
                	<div class="image">
           	...
           	<div class="col-md-3 margin30">
            	<div class="templatemo_gradient1 shadow">
            	<div class="templatemo_gradient2">
                	<div class="name">Upcomming_Events....</div>
                    <a href="upcommingevents.jsp">
                	<div class="image">
        	...
        	<div class="col-md-3 margin30">
            	<div class="templatemo_gradient1 shadow">
            	<div class="templatemo_gradient2">
                	<div class="name">view_submitted papers</div>
                    <a href="view_spaper.jsp">
                	<div class="image">
        	...
        	<div class="col-md-3 margin30">
            	<div class="templatemo_gradient1 shadow">
            	<div class="templatemo_gradient2">
                	<div class="name">Get Reviews from Reviewer</div>
                    <a href="accecpt.jsp">
                	<div class="image">
