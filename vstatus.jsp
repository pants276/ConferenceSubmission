   ...
   <!-- home start -->
   	<div class="templatemo_topbg topmargin">
        ...
        <div class="col-md-4"><img src="images/templatemo_homeicon.png" alt="template grand"></div>
                <div class="col-md-8 margin40">
					...
					<div class="title">View the Status From Chairperson</div>
	...
	<table width="606" height="219" align="center"  >
		   ...
		   <td width="228"><font  color="#CC0000"size="3"><strong>Size </strong></font></td>
			 ...
			 <td width="228"><font  color="#CC0000"size="3"><strong>View the Comments</strong></font></td>
			</tr>
...
con=databasecon.getconnection();
 ...
 String sqll="select * from paper where uemail='"+e+"' AND status='"+new1+"'";
...
<a href="vcomments.jsp?pp=<%=pid%>">View  The Command</a>
