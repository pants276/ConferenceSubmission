  ...
  <div class="container"> 
   ...
   <!-- about start -->
   	<div class="templatemo_topbg topmargin">
        ...
        <div class="col-md-4"><img  src="images/user.jpg"alt="templatemo icon"></div>
                <div class="col-md-8 margin40">
                           <font size="3" color="#FFCC00">
						   <b>
						   <ol>
						   <li>		Writes and submits the paper for conference.</li><br>
						   <li>						   
								SR-SubmissionHub project is mainly meant to be used by academic staff. However, the system will not require any higher technical knowledge and experience with similar applications. Thus general users can use it, too. 
						   </li>
						   </ol>
     	...
     	<div class="row templatemo_aboutmid">
        	<div class="col-md-3 margin30">
            	...
            	<div class="templatemo_gradient2">
                	<div class="name">Request Conference</div>
                    <a href="request_conference.jsp">
                	<div class="image">
        	...
        	<div class="col-md-3 margin30">
            	<div class="templatemo_gradient1 shadow">
            	<div class="templatemo_gradient2">
                	<div class="name">View Paper Status</div>
                    <a href="vstatus.jsp">
                	<div class="image">v
        	...
        	<div class="col-md-3 margin30"> 
            	<div class="templatemo_gradient1 shadow">
            	<div class="templatemo_gradient2">
                	<div class="name">Rejected papers</div>
                    <a href="vstatus1.jsp">
                	<div class="image">
