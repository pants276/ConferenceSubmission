  ...
  <div class="container"> 
   ...
   <!-- contact start -->
     ...
     <div class="container">
      ...
      <div class="col-md-4"> 
        <div class="templatemo_contact_map shadow"> <img src="images/form.png" height="350"> 
        </div>
      </div>
      ...
      <div class="col-md-8"> 
        <div class="templatemo_contact_form shadow"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
          ...
          <br>
          <form action="event1.jsp" method="post">
            <table width="573">
              <tr>
                <td>Name of the Event</td>
                <td><input type="text" name="nevent" placeholder="Event Name ..."></td>
              </tr>
              <tr>
                <Td>Description</Td>
              ...
              <tr>
                ...
                <td><input type="text" name="croom"></td>
              </tr>
              <tr>
                <Td>Address</Td>
